...
ROUND(Sum(tb_ventas_acumulado.subtotal),2) AS monto
FROM
tb_ventas_acumulado
INNER JOIN tb_condicion_venta ON tb_condicion_venta.id_condicion_venta = tb_ventas_acumulado.id_condicion_venta
INNER JOIN tb_cierres ON tb_ventas_acumulado.id_cierre = tb_cierres.id_cierre
WHERE
tb_ventas_acumulado.id_cierre = '$cierre_actual'
GROUP BY
tb_cierres.fecha_apertura,
tb_ventas_acumulado.id_cierre,
