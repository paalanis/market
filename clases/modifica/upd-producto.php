...
$id_producto=utf8_encode($datos['id_producto']);
$id_iva=utf8_encode($datos['id_iva']);
$id_rubro=utf8_encode($datos['id_rubro']);
$nombre=utf8_decode($datos['nombre']);
$descripcion=utf8_encode($datos['descripcion']);
$costo=utf8_encode($datos['costo']);
$venta=utf8_encode($datos['venta']);
$codigo=utf8_encode($datos['codigo']);
$foto=utf8_encode($datos['foto']);
$iva_1=utf8_encode($datos['iva']);
$rubro_1=utf8_encode($datos['rubro']);
}   
?>
